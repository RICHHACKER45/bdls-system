...
// This is where documents is seeded through
    public function run(): void
    {
        $documents = [
            ...
            ['name' => 'Barangay Clearance o Good Moral', 'reqs' => 'Valid ID, Latest Community Tax Certificate (CTC)'],
            ...
            ['name' => 'Certificate of Non-Residence', 'reqs' => 'Valid ID, Pormal na kahilingan (pamahalaan)'],
            ['name' => 'First Time Jobseekers Certification', 'reqs' => 'Valid ID, Birth certificate o PSA, Diploma o katunayan'],
            ['name' => 'BARC Certification', 'reqs' => 'Valid ID, RSBSA Enrolment form o Titulo ng lupa'],
