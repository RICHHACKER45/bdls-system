...
<body class="bg-slate-50 font-sans text-slate-900 antialiased">
    ...
    <!-- Header / Navbar -->
    <nav class="bg-white shadow-sm border-b border-slate-100 py-4 px-6 md:px-12 flex justify-between items-center sticky top-0 z-50">
        <div class="flex items-center gap-3">
            <div class="w-10 h-10 bg-red-600 rounded-full flex items-center justify-center shadow text-white font-bold text-xs">
                BDLS
            </div>
            <span class="font-bold text-lg md:text-xl tracking-tight text-slate-800 hidden sm:block">Barangay Doña Lucia Services</span>
        </div>
        <div class="flex items-center gap-4">
            <!-- Secondary Action (Sinking Box Effect) -->
            <a href="/login" class="text-slate-700 font-bold px-5 py-2 rounded-lg transition-all duration-200 hover:bg-slate-200 hover:shadow-inner active:scale-95">
                Login
            </a>
            <!-- Primary Action -->
            <a href="/signup" class="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-5 rounded-lg transition-colors shadow-sm">
                Mag-Signup
            </a>
        </div>
    </nav>
    ...
    <!-- Hero Section -->
    <!-- Ginamit ko ang slate-800 bilang placeholder background color. Pwede mong palitan ng image url mamaya -->
    <header class="relative bg-slate-800 text-white pt-24 pb-32 px-6 md:px-12 overflow-hidden">
        <div class="relative z-10 max-w-4xl">
            <h1 class="text-4xl md:text-6xl font-extrabold mb-4 tracking-tight">Welcome to Barangay Doña Lucia Services</h1>
    ...
    <!-- Ang -mt-16 (negative margin) ang nagpapataas sa main content para mag-overlap sa hero section! -->
            ...
            <div class="w-full lg:w-1/3 lg:mt-0">
                <div class="bg-white rounded-2xl shadow-xl border border-slate-100 p-8 relative overflow-hidden">
                    ...
                    <h3 class="text-xl font-bold text-slate-900 mb-4 leading-snug">
                        <!-- TODO: Huhugutin natin ito sa 'announcements' table mo kapag may backend na -->
                        ANNOUNCEMENT: Launch of the Official BDLS System
                    </h3>
                    <p class="text-slate-600 text-sm leading-relaxed mb-6">
                        Ikinagagalak naming i-anunsyo ang opisyal na pagbubukas ng website ng Barangay Doña Lucia. Layunin nitong pabilisin ang inyong pag-request ng dokumento gamit ang aming bagong SMS Queuing System.
                    </p>
                </div>
            </div>
