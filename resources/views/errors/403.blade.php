...
<body class="flex min-h-screen items-center justify-center bg-slate-50 p-4 font-sans text-slate-900">
    <div class="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-xl">
        ...
        <h1 class="mb-2 text-2xl font-extrabold text-slate-900">Bawal ang Page na ito.</h1>
        <p class="mb-6 text-sm font-medium text-slate-600">Wala kang pahintulot na tingnan ang page na ito. Maaring bumalik na sa Homepage.</p>
