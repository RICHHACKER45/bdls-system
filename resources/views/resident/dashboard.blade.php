                    ...
                    <div class="space-y-3">
                        ...
                        @forelse ($historyRequests->take(3) as $req)
                            <div class="flex items-center justify-between rounded-lg border border-slate-100 bg-slate-50 p-3">
                                ...
                                <span class="rounded px-2 py-1 text-[9px] font-black tracking-widest uppercase shadow-sm {{ $req->status === 'received' ? 'bg-green-100 text-green-700 border border-green-200' : 'bg-red-100 text-red-700 border border-red-200' }}">
                                    {{ $req->status }}
                                </span>
                            </div>
                        @empty
