...
<!-- Back Button -->
    ...
    <main class="w-full max-w-5xl mx-auto p-4 md:p-8 flex flex-col md:flex-row items-center gap-8 md:gap-16">
        ...
        <!-- LEFT SIDE: Branding (F-Pattern Start) -->
        <div class="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left">
            
            <!-- Mock Logo: Dinagdagan natin ng 'mt-12 md:mt-0' para tumulak pababa sa mobile -->
        ...
        <!-- RIGHT SIDE: Login Form (F-Pattern Action/Terminal point) -->
        <div class="w-full md:w-1/2">
            <!-- 60% White Card, 10% Black/Gray Borders -->
            <div class="bg-white rounded-2xl shadow-xl p-8 border border-slate-100">
                ...
                <form action="#" method="POST" class="space-y-5">
                    ...
                    <div>
                        <label for="contact_number" class="block text-sm font-semibold text-slate-700 mb-1">Contact Number</label>
                    ...
                    <!-- Login Button (30% Red Rule) -->
                    <button type="submit" 
                        class="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-200">
                        Pumasok
                    </button>
                </form>
