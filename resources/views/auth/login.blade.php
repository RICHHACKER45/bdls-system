    ...
    <main class="mx-auto flex w-full max-w-5xl flex-col items-center gap-8 p-4 md:flex-row md:gap-16 md:p-8">
        ...
        <div class="w-full md:w-1/2">
            <div class="rounded-2xl border border-slate-100 bg-white p-8 shadow-xl">
                ...
                <div class="mt-6">
                    <a href="/signup" class="flex w-full items-center justify-center rounded-lg border-2 border-slate-200 bg-transparent px-4 py-3.5 font-bold text-slate-600 shadow-sm transition-all duration-200 hover:border-slate-300 hover:bg-slate-50 hover:text-slate-900 active:scale-95"> Gumawa ng Account </a>
                </div>
            </div>
        </div>
    </main>
